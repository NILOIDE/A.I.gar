...
# Multiprocessing:
NUM_COLLECTORS = 1
COLLECTOR_UPDATE_STEPS = 1000
COLLECTOR_QUEUE_PUT_EXPS = int(1818/6)
NUM_EXPS_BEFORE_TRAIN = int(MEMORY_CAPACITY/80) # 1818 is 20k game steps worth of exps
ENABLE_GPU = False
